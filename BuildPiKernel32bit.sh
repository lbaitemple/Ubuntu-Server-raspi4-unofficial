...
TARGET_IMG="ubuntu-18.04.3-preinstalled-server-armhf+raspi3b.img"
TARGET_IMGXZ="ubuntu-18.04.3-preinstalled-server-armhf+raspi3b.img.xz"
DESKTOP_IMGXZ="ubuntu-18.04.3-preinstalled-desktop-armhf+raspi3.img.xz"
DESKTOP_IMG="ubuntu-18.04.3-preinstalled-desktop-armhf+raspi3.img"
SOURCE_IMG="ubuntu-18.04.3-preinstalled-server-armhf+raspi3.img"
SOURCE_IMGXZ="ubuntu-18.04.3-preinstalled-server-armhf+raspi3.img.xz"
